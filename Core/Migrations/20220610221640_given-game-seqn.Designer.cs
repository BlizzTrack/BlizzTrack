...
namespace Core.Migrations
{
    ...
    [Migration("20220610221640_given-game-seqn")]
    partial class givengameseqn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.GameParents", b =>
                {
                    ...
                    b.Property<string>("CxpProductId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Core.Models.Manifest<BNetLib.Ribbit.Models.BGDL[]>", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Core.Models.Manifest<BNetLib.Ribbit.Models.CDN[]>", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Core.Models.Manifest<BNetLib.Ribbit.Models.Summary[]>", b =>
                {
                    b.Property<int>("Seqn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Core.Models.Manifest<BNetLib.Ribbit.Models.Versions[]>", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Core.Models.Manifest<BNetLib.Ribbit.Models.BGDL[]>", b =>
                {
                    b.HasOne("Core.Models.GameConfig", "Config")
                        .WithOne()
                        .HasForeignKey("Core.Models.Manifest<BNetLib.Ribbit.Models.BGDL[]>", "ConfigId")
            ...
            modelBuilder.Entity("Core.Models.Manifest<BNetLib.Ribbit.Models.CDN[]>", b =>
                {
                    b.HasOne("Core.Models.GameConfig", "Config")
                        .WithOne()
                        .HasForeignKey("Core.Models.Manifest<BNetLib.Ribbit.Models.CDN[]>", "ConfigId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Core.Models.Manifest<BNetLib.Ribbit.Models.Versions[]>", b =>
                {
                    b.HasOne("Core.Models.GameConfig", "Config")
                        .WithOne()
                        .HasForeignKey("Core.Models.Manifest<BNetLib.Ribbit.Models.Versions[]>", "ConfigId")
                        .OnDelete(DeleteBehavior.SetNull);
